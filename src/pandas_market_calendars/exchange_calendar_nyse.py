...
from resources.pandas_market_calendars.holidays_us import (August45VictoryOverJapan, Christmas, ChristmasBefore1954,
...
class NYSEExchangeCalendar(MarketCalendar):
    ...
    """
    aliases = ['NYSE', 'stock', 'NASDAQ', 'BATS', 'AMEX', "CBOE"]
